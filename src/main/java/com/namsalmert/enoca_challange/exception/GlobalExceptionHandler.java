...
import static com.namsalmert.enoca_challange.exception.EErrorType.BAD_REQUEST_ERROR;
import static com.namsalmert.enoca_challange.exception.EErrorType.INTERNAL_ERROR;
...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleSpringMonoException(EnocaException exception){
